...
using TK.Pay.Localization;
using TK.Pay.Localization.Dto;
using TK.Pay.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace TK.Pay.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = PayConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    PayConsts.LocalizationSourceName,
                    "Save",
