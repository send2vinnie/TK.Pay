...
using TK.Pay.Dto;
using TK.Pay.Net.MimeTypes;
using OfficeOpenXml;

namespace TK.Pay.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : PayServiceBase, ITransientDependency
    {
