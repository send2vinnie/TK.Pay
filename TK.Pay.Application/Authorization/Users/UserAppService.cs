...
using TK.Pay.Authorization.Users.Exporting;
using TK.Pay.Dto;
...
namespace TK.Pay.Authorization.Users
{
    ...
    public class UserAppService : PayAppServiceBase, IUserAppService
    {
        ...
        public async Task CreateOrUpdateUser(CreateOrUpdateUserInput input)
        {
            ...
            else
            {
                ...
                input.User.Surname = "default";
                input.User.EmailAddress = Guid.NewGuid().ToString("N") + "@default.com";
