...
using TK.Pay.Authorization.Impersonation;
using TK.Pay.Authorization.Roles;
using TK.Pay.Authorization.Users;
using TK.Pay.Configuration;
using TK.Pay.Debugging;
using TK.Pay.MultiTenancy;
using TK.Pay.Notifications;
using TK.Pay.Web.Controllers.Results;
using TK.Pay.Web.Models.Account;
using TK.Pay.Web.MultiTenancy;
using Recaptcha.Web;
using Recaptcha.Web.Mvc;
using Newtonsoft.Json;
using TK.Pay.Security;
using TK.Pay.Web.Auth;
using TK.Pay.Web.Models.Layout;

namespace TK.Pay.Web.Controllers
{
    public class AccountController : PayControllerBase
    {
