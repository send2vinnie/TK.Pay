...
using TK.Pay.Sessions;
using TK.Pay.Web.Areas.Mpa.Models.Layout;
using TK.Pay.Web.Areas.Mpa.Startup;
using TK.Pay.Web.Controllers;
using TK.Pay.Web.Models.Layout;
using TK.Pay.Web.Session;
using HeaderViewModel = TK.Pay.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace TK.Pay.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : PayControllerBase
    {
